...
function main()
    ...
    rename!(snapshots, [
        :ask_1_price, :ask_1_vol, :bis_1_price, :bis_1_vol,
        :ask_2_price, :ask_2_vol, :bis_2_price, :bis_2_vol,
        :ask_3_price, :ask_3_vol, :bis_3_price, :bis_3_vol,
        :ask_4_price, :ask_4_vol, :bis_4_price, :bis_4_vol,
        :ask_5_price, :ask_5_vol, :bis_5_price, :bis_5_vol
        ])
